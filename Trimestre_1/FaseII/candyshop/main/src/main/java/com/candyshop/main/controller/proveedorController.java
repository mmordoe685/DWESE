...
@GetMapping("/{proveedor_id}/productos")
public String listarProductosPorProveedor(@PathVariable("proveedor_id") Long proveedorId, Model model) {
...
@GetMapping("/ver/{proveedor_id}")
public String verProveedorById(@PathVariable("proveedor_id")Long id , Model model) {
    if(!proveedorRepository.existsById(id)){
        model.addAttribute("error", "El proveedor no existe");
    ...
    return "listProductByProveedor.html";
